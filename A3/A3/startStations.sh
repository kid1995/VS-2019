...
########################################################################################################
#stationCmd="java Station $mcastAddress $receivePort $stationClass $UTCoffsetMs"
stationCmd="java -cp out/production/VS_A3/ Station $mcastAddress $receivePort $stationClass $UTCoffsetMs $interfaceName"
